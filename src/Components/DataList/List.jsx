  ...
  return (
    <div className="w-full sm:w-11/12 md:w-11/12 lg:w-10/12 flex-col ml-0 sm:ml-14 md:ml-24 lg:ml-36">
      {data
        ? data.map((item, index) => (
            <div
              className="w-full sm:w-11/12 md:w-10/12 lg:w-8/12 h-96 sm:h-68 sm:flex-row flex flex-col sm:mt-4 cursor-pointer"
              key={index}
            ...
            >
              <img
                ...
                alt=""
                className="w-11/12 sm:w-8/12 md:w-7/12 lg:w-6/12 h-68 object-cover rounded-xl cursor-pointer"
              />
