            ...
            video.id !== id ? (
              ...
              >
                <img
                  ...
                  alt=""
                  className="w-8/12 sm:w-4/12 lg:w-7/12 h-32 sm:h-full object-cover rounded-lg cursor-pointer"
                  onClick={() => navigate(`/video/${video.id}`)}
                />
                <div className="w-8/12 sm:w-8/12 lg:w-5/12 h-20 sm:h-full flex-col items-center pl-2">
                  <p
