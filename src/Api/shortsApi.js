...
const BASE_URL = `https://www.googleapis.com/youtube/v3/search?part=snippet&regionCode=TR&relevanceLanguage=tr&type=video&videoDuration=short&maxResults=9&key=${API_KEY}`;
